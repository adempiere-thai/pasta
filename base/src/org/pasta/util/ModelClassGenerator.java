...
public class ModelClassGenerator
{
	...
	public ModelClassGenerator (int AD_Table_ID, String directory, String packageName, String entityType)
	{
		...
		// Header
		String tableName = createHeader(AD_Table_ID, sb, mandatory, packageName,entityType);
	 ...
	 * 	@return class name
	 */
	private String createHeader (int AD_Table_ID, StringBuffer sb, StringBuffer mandatory, String packageName, String entityType)
	{
		String tableName = "";
		int accessLevel = 0;
		...
		start.append("/** Generated Model for ").append(tableName).append(NL)
			 ...
			 .append("public class ").append(className)
			 	.append(" extends org.compiere.model.").append(className)
			 	.append(" implements ").append(packageName).append(".I_").append(tableName)
			 	.append(NL)
			 .append("{").append(NL)
...
//			 .append("    }").append(NL)
	...
	public static void main (String[] args)
	{
		...
		try
		{
			...
			while (rs.next())
			{
				new ModelClassGenerator(rs.getInt(1), directory, packageName,entityType);
				count++;
			}
		}
		catch (SQLException e)
