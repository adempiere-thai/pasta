...
//	private String          m_orgName;
		...
		File AccountingFile)
	{
		...
		// Pasta 2011/04/15
		// Create AR Debit Note for New Client
		createDocType("AR Debit Note", Msg.getMsg(m_ctx, "AR Debit Note"), 
				MDocType.DOCBASETYPE_ARDebitNote, null, 0, 0, 150000, GL_ARI, false);
		...
		// Pasta 2011/04/15
		// Create AR Debit Note for New Client
		createDocType("AP Debit Note", Msg.getMsg(m_ctx, "AP Debit Note"), 
				MDocType.DOCBASETYPE_APDebitNote, null, 0, 0, 150000, GL_ARI, false);
		...
		createDocType("AR Receipt", Msg.getElement(m_ctx, "C_Payment_ID", true), 
			MDocType.DOCBASETYPE_ARReceipt, null, 0, 0, 1000, GL_ARR, false);
		createDocType("AP Payment", Msg.getElement(m_ctx, "C_Payment_ID", false), 
			MDocType.DOCBASETYPE_APPayment, null, 0, 0, 1000, GL_APP, false);
