...
/** Generated Model for M_PicklistLine
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_M_PicklistLine extends PO implements I_M_PicklistLine, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_M_PicklistLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_PicklistLine[")
	...
	public org.pasta.model.I_M_Picklist getM_Picklist() throws RuntimeException
    {
		return (org.pasta.model.I_M_Picklist)MTable.get(getCtx(), org.pasta.model.I_M_Picklist.Table_Name)
			.getPO(getM_Picklist_ID(), get_TrxName());	}
	...
	{
		if (M_Picklist_ID < 1) 
			set_Value (COLUMNNAME_M_Picklist_ID, null);
		else 
			set_Value (COLUMNNAME_M_Picklist_ID, Integer.valueOf(M_Picklist_ID));
	}
