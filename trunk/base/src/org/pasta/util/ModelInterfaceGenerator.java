...
public class ModelInterfaceGenerator
{
	...
	public ModelInterfaceGenerator(int AD_Table_ID, String directory, String packageName, String entityType) {
		this.packageName = packageName;
		// create column access methods
		StringBuffer mandatory = new StringBuffer();
		StringBuffer sb = createColumns(AD_Table_ID, mandatory,entityType);
		
		// Header
		String tableName = createHeader(AD_Table_ID, sb, mandatory,entityType);
	 ...
	 * @return class name
	 */
	private String createHeader(int AD_Table_ID, StringBuffer sb, StringBuffer mandatory,String entityType) {
		String tableName = "";
		int accessLevel = 0;
		...
		start.append("/** Generated Interface for ").append(tableName).append("\n")
			 ...
			 .append(" */\n")
			 .append("public interface ").append(className).append(" extends org.compiere.model.").append(className).append(" {").append("\n")
	 ...
	 */
	private StringBuffer createColumns(int AD_Table_ID, StringBuffer mandatory,String entityType) {
...
//				+ " AND c.ColumnName NOT LIKE 'Updated%' "
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			rs = pstmt.executeQuery();
			while (rs.next()) {
				new ModelInterfaceGenerator(rs.getInt(1), directory, packageName,entityType);
				count++;
			}
		}
		catch (SQLException e)
