...
// N
	...
	/** AP Debit Note = APD */
	public static final String DOCBASETYPE_APDebitNote = "APD";
	/** AR Debit Note = ARD */
	public static final String DOCBASETYPE_ARDebitNote = "ARD";
	/** Bill to Vendor = APB */
	public static final String DOCBASETYPE_BillToVendor = "APB";
	/** Bill from Customer = ARB */
	public static final String DOCBASETYPE_BillFromCustomer = "ARB";
	...
	/** Set Tax Invoice.
		@param IsTaxInvoice Tax Invoice	  */
	public void setIsTaxInvoice (boolean IsTaxInvoice)
	{
		set_Value (COLUMNNAME_IsTaxInvoice, Boolean.valueOf(IsTaxInvoice));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsTaxInvoice);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
