...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET IsMandatory='Y',Updated=TO_TIMESTAMP('2011-04-13 23:47:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=80001
;

-- Apr 13, 2011 11:48:43 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,206,0,80002,80002,19,215,'C_Period_ID',TO_TIMESTAMP('2011-04-13 23:48:43','YYYY-MM-DD HH24:MI:SS'),100,'U',0,'Y','Y','Y','N','Period',30,TO_TIMESTAMP('2011-04-13 23:48:43','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,196,0,80002,80003,19,124,'C_DocType_ID',TO_TIMESTAMP('2011-04-13 23:49:56','YYYY-MM-DD HH24:MI:SS'),100,'U',0,'Y','Y','N','N','Document Type',40,TO_TIMESTAMP('2011-04-13 23:49:56','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,187,0,80002,80004,30,230,'C_BPartner_ID',TO_TIMESTAMP('2011-04-13 23:51:04','YYYY-MM-DD HH24:MI:SS'),100,'U',0,'Y','N','N','N','Vendor',50,TO_TIMESTAMP('2011-04-13 23:51:04','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Apr 13, 2011 11:51:05 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET AD_Reference_ID=18, AD_Reference_Value_ID=233, AD_Val_Rule_ID=NULL,Updated=TO_TIMESTAMP('2011-04-13 23:53:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=80002
;
