...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,80074,0,'C_LocationEng_ID',TO_TIMESTAMP('2013-12-08 16:40:11','YYYY-MM-DD HH24:MI:SS'),100,'Location or Address','pasta','The Location / Address field defines the location of an entity.','Y','Address (English)','Address (English)',TO_TIMESTAMP('2013-12-08 16:40:11','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,80258,80074,0,21,228,'C_LocationEng_ID',TO_TIMESTAMP('2013-12-08 16:41:06','YYYY-MM-DD HH24:MI:SS'),100,'Location or Address','pasta',10,'The Location / Address field defines the location of an entity.','Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Address (English)',0,TO_TIMESTAMP('2013-12-08 16:41:06','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element SET Name='Address (EN)', PrintName='Address (EN)',Updated=TO_TIMESTAMP('2013-12-08 16:42:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=80074
;
...
-- Dec 8, 2013 4:42:59 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_PrintFormatItem SET PrintName='Address (EN)', Name='Address (EN)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=80074)
;

-- Dec 8, 2013 4:56:22 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=45,Updated=TO_TIMESTAMP('2013-12-08 16:56:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=80275
;
