...
-- Jun 15, 2014 1:21:43 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,113,0,80027,80101,19,80000,'AD_Org_ID',TO_TIMESTAMP('2014-06-15 13:21:43','YYYY-MM-DD HH24:MI:SS'),100,'@#AD_Org_ID@','pasta',0,'Y','Y','Y','N','Organization',11,TO_TIMESTAMP('2014-06-15 13:21:43','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,80027,80103,15,'p_DateInvoiced',TO_TIMESTAMP('2014-06-15 13:21:43','YYYY-MM-DD HH24:MI:SS'),100,'pasta',0,'Y','Y','N','Y','Receipt Date',30,TO_TIMESTAMP('2014-06-15 13:21:43','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET JasperReport='attachment:receipt2.jasper',Updated=TO_TIMESTAMP('2014-06-15 13:22:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=80027
;

-- Jun 15, 2014 1:22:06 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET Description='ใบเสร็จรับเงินแบบแสดงรายการใบแจ้งหนี้',Updated=TO_TIMESTAMP('2014-06-15 13:22:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=80027
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='p_DateReceipt',Updated=TO_TIMESTAMP('2014-06-15 13:22:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=80103
;

-- Jun 15, 2014 1:24:37 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Menu ("action",AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Created,CreatedBy,EntityType,IsActive,IsCentrallyMaintained,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('R',0,80056,0,80027,TO_TIMESTAMP('2014-06-15 13:24:37','YYYY-MM-DD HH24:MI:SS'),100,'pasta','Y','Y','N','Y','N','พิมพ์ ใบเสร็จรับเงินแบบแสดงรายการใบแจ้งหนี้',TO_TIMESTAMP('2014-06-15 13:24:37','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100,t.AD_Tree_ID, 80056, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=80056)
;

-- Jun 15, 2014 1:32:00 PM ICT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Attachment (AD_Attachment_ID,AD_Client_ID,AD_Org_ID,AD_Table_ID,Created,CreatedBy,IsActive,Record_ID,TextMsg,Title,Updated,UpdatedBy) VALUES (1000046,0,0,284,TO_TIMESTAMP('2014-06-15 13:25:08','YYYY-MM-DD HH24:MI:SS'),100,'Y',80027,NULL,'zip',TO_TIMESTAMP('2014-06-15 13:25:08','YYYY-MM-DD HH24:MI:SS'),100)
;
